 ...
 *       Linux : javac ListaDuplaFlex.java
 *       Windows: javac ListaDuplaFlex.java
 *   
 *  Para executar em terminal (janela de comandos):
 *       Linux : java ListaDuplaFlex
 *       Windows: java ListaDuplaFlex
 *   
*/
...
class Personagem 
{
    ...
    public static void swap( Celula i, Celula j, Log log ) 
    {
    ...
    public static void quickSort( Celula esq, Celula dir, Log log ) 
    {
    ...
    public static void sortByName( Lista lista, Log log )
    {
    ...
    public static void callQuick( Lista lista, Log log ) 
    {
