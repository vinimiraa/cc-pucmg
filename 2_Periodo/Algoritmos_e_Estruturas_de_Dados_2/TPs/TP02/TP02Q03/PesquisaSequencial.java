 ...
 *       Linux : javac PesquisaSequencial.java
 *       Windows: javac PesquisaSequencial.java
 *   
 *  Para executar em terminal (janela de comandos):
 *       Linux : java PesquisaSequencial
 *       Windows: java PesquisaSequencial
 *   
*/
...
class Personagem 
{
    ...
    public static Boolean pesquisaSequencial( List<Personagem> perso, String nome, Log log )
    {
        Boolean found = false;
        for( int x = 0; x < perso.size( ) && !found; x = x + 1 ) 
        {
            Personagem personagem = perso.get(x);
            if( personagem.getName().equals(nome) ) {
                found = true;
                log.incrementarComp( );
            } // end if
        } // end for
...
/**
 *  Classe PesquisaSequencial : Teste 
 */
public class PesquisaSequencial extends Personagem
{
    public static void main ( String [] args )
    {
        ...
        Log log = new Log( "812839_sequencial.txt" );
        Personagem perso = new Personagem( );
        ...
        while( !isFim( name ) )
        {
            ...
            Boolean found = pesquisaSequencial( arranjo, name, log );
